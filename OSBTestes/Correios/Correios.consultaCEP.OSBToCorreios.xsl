   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            <oracle-xsl-mapper:schema location="Correios.consultaCEP.xsd"/>
            <oracle-xsl-mapper:rootElement name="consultaCEPRequest" namespace="http://www.nauana.com"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            <oracle-xsl-mapper:schema location="Correios.wsdl"/>
            <oracle-xsl-mapper:rootElement name="consultaCEP" namespace="http://cliente.bean.master.sigep.bsb.correios.com.br/"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [FRI FEB 07 11:07:22 GMT-03:00 2020].-->
   </oracle-xsl-mapper:schema>
